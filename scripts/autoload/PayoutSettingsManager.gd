...
signal payout_settings_changed(player: bool, banker: bool, tie: bool)
...
func toggle_player(enabled: bool) -> void:
	...
	payout_settings_changed.emit(player_payout_enabled, banker_payout_enabled, tie_payout_enabled)
	SaveManager.save_payout_settings(player_payout_enabled, banker_payout_enabled, tie_payout_enabled)
...
func set_all(player: bool, banker: bool, tie: bool) -> void:
...
func _load_settings() -> void:
	...
	print("💰 PayoutSettingsManager загружен: Player=%s Banker=%s Tie=%s" % [
		player_payout_enabled, banker_payout_enabled, tie_payout_enabled
	])
