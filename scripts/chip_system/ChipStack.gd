...
const MAX_CHIPS = 20          # Максимум фишек в одной стопке
const BASE_WIDTH = 96         # Базовая ширина стека (px)
const BASE_HEIGHT = 336       # Базовая высота стека (px)
const LABEL_OFFSET = 25       # Отступ для label снизу
